import Product from '../models/Product.js';  // Thêm .js cho các mô-đun nội bộ
import Category from '../models/Category.js'; // Thêm .js cho các mô-đun nội bộ
import path from 'path';  // Không thay đổi đối với các mô-đun tích hợp
import fs from 'fs';  // Không thay đổi đối với các mô-đun tích hợp
